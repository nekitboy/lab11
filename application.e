	...
	test_biologist_id (id: NATURAL)
		...
		do
		  ...
		  biologist.id := id
			...
			new_out.open_read
			new_out.read_line
			check new_out.last_string.is_equal ("Id: " + id.out) end
			new_out.close
		end
	...
	test_biologist_name (name: STRING)
		...
		do
		  ...
		  biologist.name := name
			...
			new_out.read_line
			new_out.read_line
			check new_out.last_string.is_equal ("Name: " + name) end
			new_out.close
		end
	...
	test_biologist_discipline
		...
		do
		  ...
		  create biologist
			...
			new_out.read_line
			new_out.read_line
			check new_out.last_string.is_equal ("Discipline: biologist") end
			new_out.close
		end
	...
	test_cs_discipline
		...
		do
		  ...
		  create computer_scientist
			...
			new_out.read_line
			new_out.read_line
			check new_out.last_string.is_equal ("Discipline: computer science") end
			new_out.close
		end
	...
	test_bioinformatics_discipline
		...
		do
		  ...
		  create bio_informatics
			...
			new_out.read_line
			new_out.read_line
			check new_out.last_string.is_equal ("Discipline: bioinformatics") end
			new_out.close
		end
